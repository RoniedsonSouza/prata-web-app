...
namespace Prata.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260911195207_E4_Delivery")]
    partial class E4_Delivery
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prata.Domain.Delivery.DownloadJob", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_download_job");

                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_download_job_tenant_id");

                    b.ToTable("download_job", (string)null);
                });

            modelBuilder.Entity("Prata.Domain.Delivery.Gallery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("HasMinor")
                        .HasColumnType("boolean")
                        .HasColumnName("has_minor");
                    ...
                    b.Property<string>("PortfolioConsent")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasColumnName("portfolio_consent");

                    b.Property<DateTimeOffset?>("SelectionDeadline")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_gallery_tenant_id");

                    b.HasIndex("TenantId", "ExpiresAt")
                        .HasDatabaseName("ix_gallery_tenant_id_expires_at");

                    b.HasIndex("TenantId", "OrderId")
                        .IsUnique()
                        .HasDatabaseName("ix_gallery_tenant_id_order_id");
            ...
            modelBuilder.Entity("Prata.Domain.Delivery.Photo", b =>
                {
                    ...
                    b.Property<bool>("IsFavoriteByStudio")
                        .HasColumnType("boolean")
                        .HasColumnName("is_favorite_by_studio");
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_photo_tenant_id");

                    b.HasIndex("GalleryId", "OriginalHash")
                        .IsUnique()
                        .HasDatabaseName("ix_photo_gallery_id_original_hash");

                    b.HasIndex("TenantId", "GalleryId", "SortOrder")
                        .HasDatabaseName("ix_photo_tenant_id_gallery_id_sort_order");

                    b.ToTable("photo", (string)null);
                });

            modelBuilder.Entity("Prata.Domain.Delivery.PhotoVariant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_photo_variant");

                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_photo_variant_tenant_id");

                    b.HasIndex("PhotoId", "Kind")
                        .IsUnique()
                        .HasDatabaseName("ix_photo_variant_photo_id_kind");

                    b.ToTable("photo_variant", (string)null);
                });

            modelBuilder.Entity("Prata.Domain.Delivery.Selection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_selection_tenant_id");

                    b.HasIndex("GalleryId", "PhotoId")
                        .IsUnique()
                        .HasDatabaseName("ix_selection_gallery_id_photo_id");

                    b.ToTable("selection", (string)null);
                });

            modelBuilder.Entity("Prata.Domain.Delivery.ShareLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_share_link_tenant_id");

                    b.HasIndex("TokenHash")
                        .IsUnique()
                        .HasDatabaseName("ix_share_link_token_hash");
            ...
            modelBuilder.Entity("Prata.Domain.Delivery.Photo", b =>
                {
                    b.HasOne("Prata.Domain.Delivery.Gallery", null)
                        .WithMany("_photos")
                        .HasForeignKey("GalleryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_photo_gallery_gallery_id");
                });

            modelBuilder.Entity("Prata.Domain.Delivery.PhotoVariant", b =>
                {
                    b.HasOne("Prata.Domain.Delivery.Photo", null)
                        .WithMany("_variants")
                        .HasForeignKey("PhotoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_photo_variant_photo_photo_id");
                });

            modelBuilder.Entity("Prata.Domain.Delivery.Selection", b =>
                {
                    b.HasOne("Prata.Domain.Delivery.Gallery", null)
                        .WithMany("_selections")
                        .HasForeignKey("GalleryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_selection_gallery_gallery_id");
                });
